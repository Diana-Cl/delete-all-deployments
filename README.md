...
<img width="1080" height="2091" alt="1000017695" src="https://github.com/user-attachments/assets/84cc22f6-e494-4a92-897c-2420a8d3843c" /> <br/> 

**۲. حذف مخزن گیت‌هاب**  
اگه رپو پابلیک نشده و خیلی‌ها از روش فورک نزدن و می‌تونی حذفش کنی راحت‌ترین کار همینه، حذف کن از روی گیت‌هاب بعد راحت از کلادفلر حذف میشه،  بعد میتونی از اول بسازی دوباره با همون اسم و وصلش کنی به اکانت کلادفلر خودت. <br></br>

**۳. لغو اتصال کلادفلر به گیت‌هاب**   
از داخل ستینگ گیت‌هاب دسترسی کلادفلر رو لغو کنی، وقتی جدا بشه و دسترسی نداشته باشه راحت حذف میشه pages. فقط حواست باشه اینجوری پروژه‌های دیگه روی اون اکانت گیت‌هاب هم دسترسیشون قطع میشه و فرضا وقتی یکیشو ادیت می‌کنی دیگه اتومات اون پروژه pages روی کلادفلر دپلوی نمیشه باید دستی وصلش کنی بعدا. <br></br> 
